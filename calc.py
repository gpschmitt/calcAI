...
def main():
    ...
    printSolution(81,  (APPEND[2], SUBTRACT[4], CHANGE[2][3], reverse),                        8,    30, 5)
    printSolution(82,  (SUBTRACT[1], reverse, CHANGE[0][2]),                                 101,   222, 5)
    printSolution(83,  (MULTIPLY[4], DIVIDE[3], CHANGE[1][5], reverse),                       36,   500, 5)
    printSolution(84,  (APPEND[1], ADD[12], MULTIPLY[13], reverse, delete),                    0,   196, 8)
    printSolution(85,  (CHANGE[1][10], ADD[50], reverse, CHANGE[5][1]),                       50,   101, 5)
    printSolution(86,  (APPEND[2], MULTIPLY[4], MULTIPLY[10], reverse),                        1,  2048, 6)
    printSolution(87,  (APPEND[12], ADD[1], CHANGE[12][2], reverse),                          12,   123, 5)
    printSolution(88,  (ADD[2], ADD[14], reverse, CHANGE[0][5]),                               86,   55, 6)
    printSolution(89,  (APPEND[1], sum),                                                        0,    3, 4)
    printSolution(90,  (sum, CHANGE[3][1], CHANGE[2][3]),                                    1231,    4, 3)
    printSolution(91,  (MULTIPLY[9], APPEND[4], MULTIPLY[3], CHANGE[3][5], sum),                0,   45, 5)
    printSolution(92,  (MULTIPLY[4], CHANGE[4][6], sum),                                      424,   28, 5)
    printSolution(93,  (APPEND[3], ADD[33], sum, CHANGE[3][1]),                                 3,    8, 4)
    printSolution(94,  (DIVIDE[2], APPEND[4], CHANGE[1][2], sum),                              24,   44, 4)
    printSolution(95,  (MULTIPLY[9], ADD[9], CHANGE[44][43], sum),                            142,  143, 4)
    printSolution(96,  (DIVIDE[3], MULTIPLY[4], CHANGE[5][10], sum),                           24,    1, 5)
    printSolution(97,  (APPEND[3], MULTIPLY[3], ADD[1], sum),                                   4,  100, 5)
    printSolution(98,  (ADD[4], MULTIPLY[3], sum),                                             93,    8, 5)
    printSolution(99,  (MULTIPLY[5], DIVIDE[2], sum, CHANGE[5][2]),                             5,   16, 5)
    printSolution(100, (MULTIPLY[4], DIVIDE[4], sum, CHANGE[5][16]),                          128,   64, 4)
